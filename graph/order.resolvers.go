...
func (r *mutationResolver) CreateOrder(ctx context.Context, input model.CreateOrderInput) (*models.Order, error) {
	...
	ord, err := r.Resolver.OrderService.CreateOrder(ctx, orderInput)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) CancelOrder(ctx context.Context, orderID int, reason string) (*models.Order, error) {
	...
	ord, err := r.Resolver.OrderService.CancelOrder(ctx, uint(orderID), authUser.UserID, reason, cancelledBy)
	if err != nil {
		return nil, err
	}
...
// PickupAddress is the resolver for the pickupAddress field.
...
// DeliveryAddress is the resolver for the deliveryAddress field.
...
// ParcelType is the resolver for the parcelType field.
...
// ParcelImages is the resolver for the parcelImages field.
...
// MyDeliveries is the resolver for the myDeliveries field.
...
// MyActiveOrder is the resolver for the myActiveOrder field.
...
// MyActiveDelivery is the resolver for the myActiveDelivery field.
...
// NearbyOrders is the resolver for the nearbyOrders field.
...
// SearchOrders is the resolver for the searchOrders field.
...
// CaptainLocationUpdated is the resolver for the captainLocationUpdated field.
